...
const int TEXTGRID_WIDTH  = 60;
const int TEXTGRID_HEIGHT = 45;
const int DESIRED_FPS = 25;

// input constants
const int START_ACTION = 0;
const int STOP_ACTION = 1;
...
const int NUMBER_OF_KEYBOARD_INPUTS = 423;
const int NUMBER_OF_MOUSE_INPUTS = 10;
const int NUMBER_OF_GAMEPAD_INPUTS = 30;


extern void (*action_pointer_keyboard[ NUMBER_OF_KEYBOARD_INPUTS ]) (int action);
extern void (*action_pointer_mouse[ NUMBER_OF_MOUSE_INPUTS ]) (int action);
extern void (*action_pointer_gamepad[ NUMBER_OF_GAMEPAD_INPUTS ]) (int action);
...
extern void dummy_game_action(int action); 
