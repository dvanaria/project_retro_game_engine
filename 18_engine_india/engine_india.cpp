...
//       1         2         3         4         5         6         7         8
// Filename: ../engine_india.cpp
// Last Modified: Mon Jun 22, 2020  11:15PM
// LOC: 1044
// Filesize: 48465 bytes
//  
//
//
...
bool initialize_engine() {
    ...
    printf(" INIT ENGINE: Maximum SCALING FACTOR found to be x%d\n", 
            MAX_SCALE_FACTOR);
    fflush(stdout);
    current_scale_factor = MAX_SCALE_FACTOR; //Make initial window non-scaled 
