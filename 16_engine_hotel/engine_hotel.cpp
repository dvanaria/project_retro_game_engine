...
// Last Modified: Sat Jan 11, 2020  03:06PM
// LOC: 1046
// Filesize: 48243 bytes
//  
//
//
...
bool initialize_engine() {
    ...
    //Set text window
    TEXT_WINDOW_TOP_ROW = 1;
    TEXT_WINDOW_BOTTOM_ROW = TEXTGRID_HEIGHT - 2;
    TEXT_WINDOW_LEFT_COLUMN = 1;
    TEXT_WINDOW_RIGHT_COLUMN = TEXTGRID_WIDTH - 2;
    keyboard_cursor_x = TEXT_WINDOW_LEFT_COLUMN;
    keyboard_cursor_y = TEXT_WINDOW_TOP_ROW;
    printf(" INIT ENGINE: Text window set to full-screen (minus 1)\n");
    fflush(stdout);
...
bool build_window_and_renderer() {
    ...
    if(current_graphics_mode == FULLSCREEN_MODE) {
        ...
        window = SDL_CreateWindow("SDL2/C++ Game Engine 2019 (HOTEL)",
